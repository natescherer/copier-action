...
Report bugs at <https://github.com/copier-org/copier-action/issues>.
...
<https://github.com/copier-org/copier-action/issues>.
...
1. Clone your fork locally:
    ...
    ```shell
    git clone git@github.com:my-user/copier-action.git
    cd copier
    ```
...
The release methodology has been captured into a GitHub workflow, simply run "Release"
from the Actions panel of the repo and it will do the rest.
